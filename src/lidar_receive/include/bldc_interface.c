...
static void(*rx_value_func)(watchdog_values *values) = 0;
...
void bldc_interface_set_rx_value_func(void(*func)(watchdog_values *values)) {
	rx_value_func = func;
}
...
void bldc_interface_set_rx_lidar1_func(void(*func)(void)) {
	rx_lidar1_func = func;
}

void bldc_interface_set_rx_lidar2_func(void(*func)(void)) {
	rx_lidar2_func = func;
}

void bldc_interface_set_rx_lidar3_func(void(*func)(void)) {
	rx_lidar3_func = func;
}
...
void bldc_interface_start_map(void) {
	int32_t send_index = 0;
